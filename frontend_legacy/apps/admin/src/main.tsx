...
import { Route as providersDetailRoute } from './routes/providers.$id';
...
const routeTree = rootRoute.addChildren([
  ...
  protectedRoute.addChildren([
    ...
    providerRoute as any,
    providersRoute as any,
    providersDetailRoute as any,
  ]) as any,
]);
...
import { ProviderModule } from '@sodars/module-provider';

// Install Provider Module dynamically
ModuleManager.install(new ProviderModule(), bootstrapContext)
  .then(() => {
    console.log('[App] ProviderModule installed successfully!');
  })
  .catch(err => {
    console.error('[App] Failed to install ProviderModule:', err);
  });
