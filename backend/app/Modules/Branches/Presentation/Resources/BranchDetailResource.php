...
{
    /**
     * Transform the resource into an array with loaded members/coverage.
     *
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'members' => BranchMemberResource::collection($this->whenLoaded('members')),
            'coverage_areas' => BranchCoverageAreaResource::collection($this->whenLoaded('coverageAreas')),
